...
::default Pool
		...
		IF %ERRORLEVEL% ==1 (		set type="1" 
						set runner="http://eth-eu.dwarfpool.com:80/0x7F5BB53c415334235a9E42eA03695F11b6553C0D/GTX1060/yourmail@adress.com" )
		IF %ERRORLEVEL% ==2 (		set type="1" 
						set runner="http://127.0.0.1:8080/GTX1060/yourmail@adress.com" )
		IF %ERRORLEVEL% ==3 (		set type="1" 
						set runner="http://etc-eu1.nanopool.org:18888/0x7F5BB53c415334235a9E42eA03695F11b6553C0D/1/yourmail@adress.com")
		IF %ERRORLEVEL% ==4 (		set type="1" 
						set runner="http://eth-eu1.nanopool.org:8888/0x7F5BB53c415334235a9E42eA03695F11b6553C0D/GTX1060/yourmail@adress.com")
		IF %ERRORLEVEL% ==5 (		set type="2" 
						set runner= "eu1.ethermine.org:4444" 
						set user="0x7F5BB53c415334235a9E42eA03695F11b6553C0D.Miner1" )
