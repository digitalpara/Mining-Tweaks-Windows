...
color 1F
rem Set title
title Windows 10 Mining Tweaks (x64) Version %V% by: SiMSEK-DiGITALPARA
...
echo ###############################################################################
echo #                                                                             #
echo #  Windows10MiningTweaks    Version %V%                                     #
echo #                                                                             #
echo #  Microsoft Windows 10  --  Build 10240 (x64) or later                       #
echo #                                                                             #
echo #  AUTHOR: SiMSeK (DiGiTaLParaTO-GitHub)                                      #
echo #                                                                             #
echo #                                                                             #
echo #  Features                                                                   #
echo #                                                                             #
echo #  1. Registry Tweaks (Donate ETH:0x7F5BB53c415334235a9E42eA03695F11b6553C0D) #
